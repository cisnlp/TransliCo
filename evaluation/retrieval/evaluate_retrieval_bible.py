...
def main():
    ...
    if args.init_checkpoint:
        ...
        args.output_dir += args.init_checkpoint.split('/')[-1]
        args.output_dir += f"/checkpoint-{str(args.checkpoint_num)}"
        args.init_checkpoint += f"/checkpoint-{str(args.checkpoint_num)}"
    else:
